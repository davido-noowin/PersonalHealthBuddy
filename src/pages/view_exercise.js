...
export function ViewExercisePage({ navigation }) {
	...
	const getExerciseScores = async (username) => {
		try {
            ...
            console.log("sending request to " + "http://18.226.94.38:8000/api/get-exercise" + request_parameters)
			const res = await fetch("http://18.226.94.38:8000/api/get-exercise" + request_parameters);
